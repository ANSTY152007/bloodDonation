                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div><strong>g@gmail.com</strong></div>
...
<h1>welcome <span class="mx-4"><?php echo $_SESSION['adminemail'];?></h1></span><br>
            <div class="row">
                <!--quick info section -->
                <div class="col-lg-3">
                    <div class="alert alert-danger text-center">
                        <i class="fa fa-calendar fa-3x"></i>&nbsp;<b><?php echo countDonors();?> </b>Donors 

                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="alert alert-success text-center">
                        <i class="fa  fa-beer fa-3x"></i>&nbsp;<b><?php echo countusers();?> </b>users
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="alert alert-info text-center">
                        <i class="fa fa-rss fa-3x"></i>&nbsp;<b><?php echo countrequests();?> </b>requests
            ...
            <div class="row">
                ...
                <h1 style="text-align:center;color:white">ADMIN DETAILS </h1>
...
<tr>
   ...
   $i=1;
         ...
         if($records > 0)
         {
              ...
              <td><a href="adminupdate.php?adminemail='.$data["adminemail"].'" class="btn btn-success">update</td>
