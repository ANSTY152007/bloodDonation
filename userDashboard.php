...
<a href="userreg.php" class="btn btn-info sm-2" style="padding:20px;">Add New user</a></div>
        ...
        $email = $_SESSION['email'];
         ...
         //echo "Records ".mysqli_num_rows($responce);
           ...
           if(mysqli_num_rows($responce)>0)
           {
              ...
              <td><a href="updateuser.php?email='.$data["email"].'" class="btn btn-success">update
              <a href="userdelete.php?email='.$data["email"].'" class="btn btn-danger mx-2">delete
